...
- [Replay Coverage Below Truth Bar](records/issue-replay-coverage-below-truth-bar.md) — Replay and fixture evidence are still weaker than the truthful-graph bar
