...
## Decision
External repo audits will be stored in the Socratinker KB and triaged there. They will not become a separate standing backlog.
...
## Product Implication
When a new audit arrives, the repo should capture it under `.socratinker/` and promote at most a few release-relevant items into active work. This keeps the project epistemically honest and operationally light.
