...
Canonical path: `agents/ONBOARDING.md`.
Shared workflow canon: `agents/README.md`, `agents/WORKFLOWS/`, and `agents/founder/WORKFLOWS/`.

## Read Order
1. [AGENTS.md](../AGENTS.md)
2. [agents/README.md](./README.md)
3. [agents/LEARNINGS.md](./LEARNINGS.md) when the task touches agent/founder workflow design, bootstrap, publication safety, artifact placement, verification discipline, workflow-card creation, or recurring workflow friction
