...
- [agents/_templates/agent-review-entry.md](../_templates/agent-review-entry.md)
...
> Canonical paths after refactor: `agents/ONBOARDING.md` and `.agents/codex/glenna.toml`.
