...
- Working notes — keep them out of ADRs; if they matter long-term, promote only the durable rule into an active canonical doc.
...
- [ADR-0005 — LSL is a one-way evidence projection](0005-lsl-interchange-boundary.md)
