...
- [../product/spec.md](../product/spec.md) — binding product contract for the three-phase loop, routing, progression layers, inline concept-entry/result-surface modes, and guardrails
