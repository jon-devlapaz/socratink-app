...
| UX doctrine | `/DESIGN.md` (slim hub) + `docs/design/socratink-ux.md` (full manifesto) | The product thesis, three-phase loop, node-state model, feedback calibration rules, voice |
