...
>
> **What it is NOT**: It is not the routing/state implementation spec (read `progressive-disclosure.md`), the drill-doc rebuild note and current truth routing (read `../drill/README.md`), or the full UX doctrine (read `/DESIGN.md`).
>
