...
>
> **What it is NOT**: It is not the routing/state implementation spec (read `progressive-disclosure.md`), the engineering invariants (read `../drill/engineering.md`), or the full UX doctrine (read `/DESIGN.md`).
>
