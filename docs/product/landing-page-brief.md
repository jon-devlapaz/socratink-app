...
| Primary action — the first reconstruction | `Write what you remember` | (replaces older "Try from memory" / "Start Cold Attempt") |
...
Primary CTA: `Open socratink` or `Open a smallest route` or `Write what you remember`
