 ...
 * override gate (env flag + loopback), selection validation,
...
function isLoopbackRequest(req) {
  ...
  return isLoopbackHost(host) && isLoopbackHost(socketAddress);
}
...
export function llmEnvOverrides(llm, env = process.env) {
  ...
  return {
    ...
    LLM_BASE_URL:
      target === "lmstudio"
        ...
        : env.LLM_ROUTER_BASE_URL || "",
    LLM_API_KEY:
      target === "lmstudio"
        ? env.LM_STUDIO_API_KEY || "lm-studio"
        : env.LLM_ROUTER_API_KEY || "",
  };
}
