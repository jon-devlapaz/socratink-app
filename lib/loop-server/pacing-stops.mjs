...
const STOPS = Object.freeze({
  initial_reconstruction_submitted: {
    phaseAfter: "reconstruction_gap",
    promptMeta: {
      key: "evaluate_reconstruction_gap",
      label: "Explanation saved",
      ctaText: "Your exact explanation is recorded. Finding one gap…",
    },
  },
  initial_repair_submitted: {
    phaseAfter: "idle",
    promptMeta: {
      key: "initial_repair_saved",
      label: "Repair saved",
      ctaText: "Your repair is recorded exactly as written.",
      readOnly: true,
    },
  },
  route_generated: {
    phaseAfter: "cold_attempt",
    promptMeta: { key: "cold_attempt", label: "First question: " },
  },
  cold_attempt: {
    phaseAfter: "delta",
  ...
  model_bridge: {
    ...
    promptMeta: {
      key: "run_gap_drill",
      label: "Try one transfer check? y/N: ",
      fallback: "n",
    },
  },
});
