...
export function createHttpPrompt({ cache, askCounts, session, env = process.env }) {
  return {
    // Async so thrown promptRequired rejects the returned promise (HTTP pacing contract).
    // eslint-disable-next-line @typescript-eslint/require-await -- sync body; async for rejectable throws
