...
const persistedFieldsByType = {
  ...
  initial_reconstruction_submitted: ["text", "at", "phase"],
  initial_repair_submitted: [
    "text",
    "at",
    "phase",
...
const requiredFieldsByType = {
  ...
  initial_reconstruction_submitted: ["text", "at", "phase"],
  initial_repair_submitted: ["text", "at", "phase", "gap_id"],
...
export const eventBuilders = Object.freeze({
  ...
  initialReconstructionSubmitted: ({ text, at }) =>
    buildEvent("initial_reconstruction_submitted", {
      text,
      at,
  ...
  initialRepairSubmitted: ({ text, at, gap_id }) =>
    buildEvent("initial_repair_submitted", {
      text,
      at,
      gap_id,
  ...
  targetSubmitted: ({ text, at }) =>
    buildEvent("target_submitted", {
      text,
      at,
      phase: "source_intake",
      graph_neutral: true,
