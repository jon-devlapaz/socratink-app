...
const LEGACY_TO_CANONICAL = Object.freeze({
  ...
  target_submitted: ["goal_submitted"],
  initial_reconstruction_submitted: ["cold_attempt_submitted"],
  initial_repair_submitted: ["repair_submitted"],
...
const ONE_TO_ONE_RUNTIME_DEFAULT_SOURCE_TYPES = new Set([
  "source_submitted",
  "target_submitted",
  "initial_reconstruction_submitted",
  "initial_repair_submitted",
...
export const CANONICAL_LEARNER_LOOP_EVENTS = Object.freeze({
  ...
  source_submitted: def("source_submitted", {
    source_event_types: ["source_submitted"],
  }),
  goal_submitted: def("goal_submitted", {
    source_event_types: ["target_submitted"],
  }),
  ...
  cold_attempt_submitted: def("cold_attempt_submitted", {
    graph_neutral: false,
    score_eligible: true,
    source_event_types: ["cold_attempt", "initial_reconstruction_submitted"],
  }),
  ...
  bridge_submitted: def("bridge_submitted", {
    source_event_types: ["post_bridge_transfer_check"],
  }),
...
const DEFAULT_PHASE_BY_CANONICAL = Object.freeze({
  ...
  source_submitted: "source_intake",
  goal_submitted: "source_intake",
