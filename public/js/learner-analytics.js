  ...
  branchFriction.innerHTML = createList(
    ...
    (item) => `
      <div class="list-card">
        ...
        <div class="list-card-metrics">
          <span class="metric-pill pill pill--solid">Solid ${item.counts.solidified}</span>
          <span class="metric-pill pill pill--primed">Primed ${item.counts.primed}</span>
          <span class="metric-pill pill pill--drilled">In progress ${item.counts.drilled}</span>
          <span class="metric-pill pill pill--danger">Misconceptions ${item.history.misconception_count}</span>
        </div>
      </div>
    `,
  );
