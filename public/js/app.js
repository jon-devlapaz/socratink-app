...
import { bootstrapAuthUi, buildLoginHref, fetchAuthSession, logout, redirectToLogin } from './auth.js?v=3';
...
const App = (() => {
  ...
  function getHeroGuidance(concept) {
    if (!concept) return 'Name one concept or paste source material. The first room asks for a small cold attempt before any explanation appears.';
