...
const CASES_PATH = path.join(REPO_ROOT, 'scripts/socratink_tui/learning_cases/cases.jsonl');

function usage() {
  return [
    'Usage: scripts/socratink-harness replay',
    '',
...
async function loadSession(caseRecord) {
  ...
  const sessionPath = path.join(REPO_ROOT, caseRecord.session_log);
